...
public class Foods extends javax.swing.JDialog {
     ...
     */
    public Foods(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
stable.addMouseListener(new MouseAdapter()   
   ...
   foodID=String.valueOf(stable.getModel().getValueAt(row, 0));
   foodName=String.valueOf(stable.getModel().getValueAt(row, 1));
   foodPrice=String.valueOf(stable.getModel().getValueAt(row, 2));
