...
private void regProd()
{
try { 
         Class.forName("com.mysql.jdbc.Driver");
         conn = DriverManager.getConnection(UserLogin.url,UserLogin.username,UserLogin.password);
...
conn.close();
    ...
    private void initComponents() {
        ...
        cat.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Foods", "Drinks", "Others" }));
...
else regProd();// TODO add your handling code here:
