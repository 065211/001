...
public class Others extends javax.swing.JDialog {
    ...
    Connection conn;
    Statement stm; 
    JTable OthersTable,stable;
    int A,B;
    JScrollPane scrollPane;
    String OthersName,OthersPrice;
    String OthersID="";
     ...
     */
    public Others(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
String sql = "SELECT ID,Name,Price from inventory WHERE Category='Others' && Quantity>1";
...
stable.addMouseListener(new MouseAdapter()   
   ...
   OthersID=String.valueOf(stable.getModel().getValueAt(row, 0));
   OthersName=String.valueOf(stable.getModel().getValueAt(row, 1));
   OthersPrice=String.valueOf(stable.getModel().getValueAt(row, 2));
...
try { 
         ...
         statement.setString(2,OthersID);
         statement.setString(3,OthersName);
         statement.setString(4,OthersPrice);
                 
         statement.executeUpdate();
         statement.close();
            
         int k;
            k=JOptionPane.showConfirmDialog(jPanel2,"An order for "+OthersName+" has been successfully placed! Do you wish to make another drink order?","Order Made",JOptionPane.YES_NO_OPTION);
...
try { 
         ...
         conn = DriverManager.getConnection(url,username,password);
         PreparedStatement statement = conn.prepareStatement
         ("UPDATE inventory SET Quantity=Quantity-1 WHERE ID="+OthersID+"");
...
this.dispose();        // TODO add your handling code here:
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        ...
        int choice;
            choice=JOptionPane.showConfirmDialog(jPanel2,"An order for "+OthersName+" will be  placed! Are you sure you want to place the order?","Order Confirmation",JOptionPane.YES_NO_OPTION);
